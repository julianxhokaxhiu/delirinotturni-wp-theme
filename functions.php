<?php
	...
	function load_scripts(){
		...
		wp_enqueue_script('bootstrap', THEME_URL.'/js/bootstrap.min.js', array(), false, true);
	...
	function load_styles(){
		/*wp_register_style( 'screen', THEME_URL.'/css/bootstrap.min.css', '', '', 'screen' );
		wp_register_style( 'screen', THEME_URL.'/style.css', '', '', 'screen' );
		wp_register_style( 'screen', THEME_URL.'/css/bootstrap-responsive.min.css', '', '', 'screen' );
	...
	if (!defined("THEME_LOC"))define("THEME_LOC", __DIR__);
	...
	// Add my custom data
	$data['themeurl'] = get_template_directory_uri();